...
public class EmployeeMock {
    ...
    public static EmployeeDto getMockedEmployeeDto1() { return EmployeeDto.builder().id(1).name("Abigail Johnson").email("abigail.johnson@example.com").password("$2a$10$7UUcqTY7jdmZDBOBDiZ3g.HqGB6D06nJP/AwvPFV7rwo9uOaZNIl").mobile("+40754321837").address("999 Oak St, Athens, Greece").birthday(LocalDate.of(2000, 10, 2)).roleId(1).employmentType(FULL_TIME).position(FRONTEND).grade(JUNIOR).mentorId(1).studiesIds(List.of(1, 2)).experiencesIds(List.of(1, 2)).build(); }
