...
public class EmployeeRestController implements EmployeeApi {
    ...
    public ResponseEntity<PageWrapper<EmployeeDto>> findAllByKey(@PageableDefault(size = 2, sort = "id") Pageable pageable, @RequestParam(required = false, defaultValue = "") String key) {
