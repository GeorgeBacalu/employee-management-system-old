...
public class MentorRestController implements MentorApi {
    ...
    public ResponseEntity<PageWrapper<MentorDto>> findAllByKey(@PageableDefault(size = 2, sort = "id") Pageable pageable, @RequestParam(required = false, defaultValue = "") String key) {
