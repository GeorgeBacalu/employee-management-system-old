...
public class UserRestController implements UserApi {
    ...
    public ResponseEntity<PageWrapper<UserDto>> findAllByKey(@PageableDefault(size = 2, sort = "id") Pageable pageable, @RequestParam(required = false, defaultValue = "") String key) {
